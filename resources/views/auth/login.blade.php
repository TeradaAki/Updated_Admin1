...
<body class="align">
    <div class="grid">
        <form action="{{route('login-user')}}" method="post" class="form login">
            <div class="img">
                <img src="img/onway_logo.png" alt="Onway Logo">
            </div>
            <hr>
            ...
            <div class="form__field">
                ...
                <input type="text" id="login__username" class="form__input" placeholder="Email Address" name="email" value="{{old('email')}}">
            ...
            <div class="form__field">
                <input class="form-control" type="submit" value="Sign In"></input>
            </div>
        </form>

        {{-- <p class="text--center">not a member?<a href="registration"> Register here </a><svg class="icon">
        <use xlink:href="#bi bi-arrow-right"></use>
        </svg></p> --}}
    </div>
